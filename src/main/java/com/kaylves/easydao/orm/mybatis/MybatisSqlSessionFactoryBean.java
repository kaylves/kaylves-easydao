 ...
 */
package com.kaylves.easydao.orm.mybatis;
...
public class MybatisSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
  ...
  private List<Resource> mapperResources;
  ...
  public void initMybatisResources() throws IOException
  {
      ResourceLoader resourceLoader = new DefaultResourceLoader();
      
      ResourcePatternResolver resourcePatternResolver = new PathMatchingResourcePatternResolver(resourceLoader);
      
      this.mapperResources = new LinkedList<Resource>();
      
      for(String temp :this.mapperLocations)
      {
          Resource[] resources = resourcePatternResolver.getResources(temp);
          this.mapperResources.addAll( Arrays.asList( resources ) );
      }
  ...
  protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
    ...
    if (!isEmpty(this.mapperLocations)) {
      for (Resource mapperLocation : this.mapperResources) {
