 ...
 * @author Kaylves
 * @create_date 2014-6-24 下午10:11:19
 * @version 1.0
 * @update_user Kaylves
 * @update_date 2014-6-24 下午10:11:19
 * @description 此处写类的描述
 */
public class ExportCertFormKeystore {
	...
	public void export() {
		...
		String[] arstringCommand = new String[] {
				...
				"d:/demo.keystore", "-alias", 	// -alias指定别名，这里是ss
				"ss", "-file",					// -file指向导出路径
				"d:/demo.cer", "-storepass",	// 指定密钥库的密码
				"123456"
		};
		execCommand(arstringCommand);
	...
	public static void main(String[] args) {
		ExportCertFormKeystore key = new  ExportCertFormKeystore();
		key.export();
	}
